...
import (
	...
	"github.com/openchami/user-service-postgres/internal/storage/ent/annotation"
	...
	"github.com/openchami/user-service-postgres/internal/storage/ent/resource"
...
// SetNamespace sets the "namespace" field.
func (m *UserMutation) SetNamespace(s string) {
	m.namespace = &s
}

// Namespace returns the value of the "namespace" field in the mutation.
func (m *UserMutation) Namespace() (r string, exists bool) {
	v := m.namespace
	if v == nil {
		return
	}
...
// OldNamespace returns the old "namespace" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldNamespace(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldNamespace is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *UserMutation) ClearNamespace() {
	m.namespace = nil
	m.clearedFields[user.FieldNamespace] = struct{}{}
}

// NamespaceCleared returns if the "namespace" field was cleared in this mutation.
func (m *UserMutation) NamespaceCleared() bool {
	_, ok := m.clearedFields[user.FieldNamespace]
	return ok
}
...
func (m *UserMutation) ResetNamespace() {
	m.namespace = nil
	delete(m.clearedFields, user.FieldNamespace)
}

// SetAPIVersion sets the "api_version" field.
func (m *UserMutation) SetAPIVersion(s string) {
	m.api_version = &s
}

// APIVersion returns the value of the "api_version" field in the mutation.
func (m *UserMutation) APIVersion() (r string, exists bool) {
	v := m.api_version
	if v == nil {
		return
	}
...
// OldAPIVersion returns the old "api_version" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldAPIVersion(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAPIVersion is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetAPIVersion resets all changes to the "api_version" field.
func (m *UserMutation) ResetAPIVersion() {
	m.api_version = nil
}

// SetKind sets the "kind" field.
func (m *UserMutation) SetKind(s string) {
	m.kind = &s
}

// Kind returns the value of the "kind" field in the mutation.
func (m *UserMutation) Kind() (r string, exists bool) {
	v := m.kind
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldKind(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldKind is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// SetResourceVersion sets the "resource_version" field.
func (m *UserMutation) SetResourceVersion(s string) {
	m.resource_version = &s
}

// ResourceVersion returns the value of the "resource_version" field in the mutation.
func (m *UserMutation) ResourceVersion() (r string, exists bool) {
	v := m.resource_version
	if v == nil {
		return
	}
...
// OldResourceVersion returns the old "resource_version" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldResourceVersion(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldResourceVersion is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetResourceVersion resets all changes to the "resource_version" field.
func (m *UserMutation) ResetResourceVersion() {
	m.resource_version = nil
}

// SetSpecData sets the "spec_data" field.
func (m *UserMutation) SetSpecData(jm json.RawMessage) {
	m.spec_data = &jm
	m.appendspec_data = nil
}

// SpecData returns the value of the "spec_data" field in the mutation.
func (m *UserMutation) SpecData() (r json.RawMessage, exists bool) {
	v := m.spec_data
	if v == nil {
		return
	}
...
// OldSpecData returns the old "spec_data" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldSpecData(ctx context.Context) (v json.RawMessage, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) AppendSpecData(jm json.RawMessage) {
...
func (m *UserMutation) AppendedSpecData() (json.RawMessage, bool) {
...
func (m *UserMutation) ClearSpecData() {
	m.spec_data = nil
	m.appendspec_data = nil
	m.clearedFields[user.FieldSpecData] = struct{}{}
}

// SpecDataCleared returns if the "spec_data" field was cleared in this mutation.
func (m *UserMutation) SpecDataCleared() bool {
	_, ok := m.clearedFields[user.FieldSpecData]
	return ok
}

// ResetSpecData resets all changes to the "spec_data" field.
func (m *UserMutation) ResetSpecData() {
	m.spec_data = nil
	m.appendspec_data = nil
	delete(m.clearedFields, user.FieldSpecData)
}

// SetSpecUsername sets the "spec_username" field.
func (m *UserMutation) SetSpecUsername(s string) {
	m.spec_username = &s
}

// SpecUsername returns the value of the "spec_username" field in the mutation.
func (m *UserMutation) SpecUsername() (r string, exists bool) {
	v := m.spec_username
	if v == nil {
		return
	}
...
// OldSpecUsername returns the old "spec_username" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldSpecUsername(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecUsername is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecUsername requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecUsername: %w", err)
	}
	return oldValue.SpecUsername, nil
}

// ClearSpecUsername clears the value of the "spec_username" field.
func (m *UserMutation) ClearSpecUsername() {
	m.spec_username = nil
	m.clearedFields[user.FieldSpecUsername] = struct{}{}
}

// SpecUsernameCleared returns if the "spec_username" field was cleared in this mutation.
func (m *UserMutation) SpecUsernameCleared() bool {
	_, ok := m.clearedFields[user.FieldSpecUsername]
	return ok
}

// ResetSpecUsername resets all changes to the "spec_username" field.
func (m *UserMutation) ResetSpecUsername() {
	m.spec_username = nil
	delete(m.clearedFields, user.FieldSpecUsername)
}

// SetSpecEmail sets the "spec_email" field.
func (m *UserMutation) SetSpecEmail(s string) {
	m.spec_email = &s
}

// SpecEmail returns the value of the "spec_email" field in the mutation.
func (m *UserMutation) SpecEmail() (r string, exists bool) {
	v := m.spec_email
	if v == nil {
		return
	}
...
// OldSpecEmail returns the old "spec_email" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldSpecEmail(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecEmail is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecEmail requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecEmail: %w", err)
	}
	return oldValue.SpecEmail, nil
}

// ClearSpecEmail clears the value of the "spec_email" field.
func (m *UserMutation) ClearSpecEmail() {
	m.spec_email = nil
	m.clearedFields[user.FieldSpecEmail] = struct{}{}
}

// SpecEmailCleared returns if the "spec_email" field was cleared in this mutation.
func (m *UserMutation) SpecEmailCleared() bool {
	_, ok := m.clearedFields[user.FieldSpecEmail]
	return ok
}

// ResetSpecEmail resets all changes to the "spec_email" field.
func (m *UserMutation) ResetSpecEmail() {
	m.spec_email = nil
	delete(m.clearedFields, user.FieldSpecEmail)
}

// SetSpecPassword sets the "spec_password" field.
func (m *UserMutation) SetSpecPassword(s string) {
	m.spec_password = &s
}

// SpecPassword returns the value of the "spec_password" field in the mutation.
func (m *UserMutation) SpecPassword() (r string, exists bool) {
	v := m.spec_password
	if v == nil {
		return
	}
...
// OldSpecPassword returns the old "spec_password" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldSpecPassword(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecPassword is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecPassword requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecPassword: %w", err)
	}
	return oldValue.SpecPassword, nil
}

// ClearSpecPassword clears the value of the "spec_password" field.
func (m *UserMutation) ClearSpecPassword() {
	m.spec_password = nil
	m.clearedFields[user.FieldSpecPassword] = struct{}{}
}

// SpecPasswordCleared returns if the "spec_password" field was cleared in this mutation.
func (m *UserMutation) SpecPasswordCleared() bool {
	_, ok := m.clearedFields[user.FieldSpecPassword]
	return ok
}

// ResetSpecPassword resets all changes to the "spec_password" field.
func (m *UserMutation) ResetSpecPassword() {
	m.spec_password = nil
	delete(m.clearedFields, user.FieldSpecPassword)
}

// SetSpecRole sets the "spec_role" field.
func (m *UserMutation) SetSpecRole(s string) {
	m.spec_role = &s
}

// SpecRole returns the value of the "spec_role" field in the mutation.
func (m *UserMutation) SpecRole() (r string, exists bool) {
	v := m.spec_role
	if v == nil {
		return
	}
...
// OldSpecRole returns the old "spec_role" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldSpecRole(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecRole is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecRole requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecRole: %w", err)
	}
	return oldValue.SpecRole, nil
}

// ClearSpecRole clears the value of the "spec_role" field.
func (m *UserMutation) ClearSpecRole() {
	m.spec_role = nil
	m.clearedFields[user.FieldSpecRole] = struct{}{}
}

// SpecRoleCleared returns if the "spec_role" field was cleared in this mutation.
func (m *UserMutation) SpecRoleCleared() bool {
	_, ok := m.clearedFields[user.FieldSpecRole]
	return ok
}

// ResetSpecRole resets all changes to the "spec_role" field.
func (m *UserMutation) ResetSpecRole() {
	m.spec_role = nil
	delete(m.clearedFields, user.FieldSpecRole)
}

// SetSpecActive sets the "spec_active" field.
func (m *UserMutation) SetSpecActive(b bool) {
	m.spec_active = &b
}

// SpecActive returns the value of the "spec_active" field in the mutation.
func (m *UserMutation) SpecActive() (r bool, exists bool) {
	v := m.spec_active
	if v == nil {
		return
	}
...
// OldSpecActive returns the old "spec_active" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldSpecActive(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecActive is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecActive requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecActive: %w", err)
	}
	return oldValue.SpecActive, nil
}

// ClearSpecActive clears the value of the "spec_active" field.
func (m *UserMutation) ClearSpecActive() {
	m.spec_active = nil
	m.clearedFields[user.FieldSpecActive] = struct{}{}
}

// SpecActiveCleared returns if the "spec_active" field was cleared in this mutation.
func (m *UserMutation) SpecActiveCleared() bool {
	_, ok := m.clearedFields[user.FieldSpecActive]
	return ok
}

// ResetSpecActive resets all changes to the "spec_active" field.
func (m *UserMutation) ResetSpecActive() {
	m.spec_active = nil
	delete(m.clearedFields, user.FieldSpecActive)
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.namespace != nil {
		fields = append(fields, user.FieldNamespace)
	}
	if m.api_version != nil {
		fields = append(fields, user.FieldAPIVersion)
	}
	if m.kind != nil {
	...
	if m.resource_version != nil {
		fields = append(fields, user.FieldResourceVersion)
	}
	if m.spec_data != nil {
		fields = append(fields, user.FieldSpecData)
	}
	if m.spec_username != nil {
		fields = append(fields, user.FieldSpecUsername)
	}
	if m.spec_email != nil {
		fields = append(fields, user.FieldSpecEmail)
	}
	if m.spec_password != nil {
		fields = append(fields, user.FieldSpecPassword)
	}
	if m.spec_role != nil {
		fields = append(fields, user.FieldSpecRole)
	}
	if m.spec_active != nil {
		fields = append(fields, user.FieldSpecActive)
	}
	return fields
}
...
func (m *UserMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case user.FieldSpecUsername:
		return m.OldSpecUsername(ctx)
	case user.FieldSpecEmail:
		return m.OldSpecEmail(ctx)
	case user.FieldSpecPassword:
		return m.OldSpecPassword(ctx)
	case user.FieldSpecRole:
		return m.OldSpecRole(ctx)
	case user.FieldSpecActive:
		return m.OldSpecActive(ctx)
	}
...
func (m *UserMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(user.FieldNamespace) {
		fields = append(fields, user.FieldNamespace)
	}
	if m.FieldCleared(user.FieldSpecData) {
		fields = append(fields, user.FieldSpecData)
	}
	if m.FieldCleared(user.FieldSpecUsername) {
		fields = append(fields, user.FieldSpecUsername)
	}
	if m.FieldCleared(user.FieldSpecEmail) {
		fields = append(fields, user.FieldSpecEmail)
	}
	if m.FieldCleared(user.FieldSpecPassword) {
		fields = append(fields, user.FieldSpecPassword)
	}
	if m.FieldCleared(user.FieldSpecRole) {
		fields = append(fields, user.FieldSpecRole)
	}
	if m.FieldCleared(user.FieldSpecActive) {
		fields = append(fields, user.FieldSpecActive)
	}
	return fields
}
