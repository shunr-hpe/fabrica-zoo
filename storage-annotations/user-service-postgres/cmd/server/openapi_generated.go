...
import (
	...
	"github.com/openchami/user-service-postgres/apis/storage-annotations.openchami.org/v1"
)
...
<head>
    <meta charset="UTF-8">
    <title>user_service_postgres API Documentation</title>
...
func GenerateOpenAPISpec() *openapi3.T {
	spec := &openapi3.T{
		OpenAPI: "3.0.0",
		Info: &openapi3.Info{
			Title:       "user_service_postgres API",
