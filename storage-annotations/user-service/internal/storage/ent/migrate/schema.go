...
var (
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "spec_username", Type: field.TypeString, Unique: true, Nullable: true},
		{Name: "spec_email", Type: field.TypeString, Unique: true, Nullable: true},
		{Name: "spec_password", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"mysql": "varchar(60)", "postgres": "varchar(60)", "sqlite3": "TEXT"}},
		{Name: "spec_role", Type: field.TypeString, Nullable: true, Default: "user"},
		{Name: "spec_active", Type: field.TypeBool, Nullable: true, Default: true},
	}
	...
	UsersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "user_name_namespace",
				Unique:  false,
				Columns: []*schema.Column{UsersColumns[2], UsersColumns[3]},
			},
			{
				Name:    "user_spec_username",
				Unique:  false,
				Columns: []*schema.Column{UsersColumns[10]},
			},
			{
				Name:    "user_spec_email",
				Unique:  false,
