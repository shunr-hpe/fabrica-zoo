...
import (
	...
	_ "github.com/openchami/node-service-sqlite/pkg/apiversion"
...
var rootCmd = &cobra.Command{
	Use:   "node-service-sqlite",
	Short: "",
	Long:  `node-service-sqlite - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the node-service-sqlite server",
	Long:  `Start the node-service-sqlite HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.node-service-sqlite.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".node-service-sqlite")
	}
...
func runServer(cmd *cobra.Command, args []string) error {
	log.Printf("Starting node-service-sqlite server...")
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"node-service-sqlite"}`))
}
