...
//
// This file provides a Cobra-based CLI for the node_service_postgres API.
...
//   --server       Server URL (env: NODE_SERVICE_POSTGRES_SERVER)
//   --timeout      Request timeout (env: NODE_SERVICE_POSTGRES_TIMEOUT)
...
//   2. Environment variables (NODE_SERVICE_POSTGRES_*)
//   3. Config file (~/.node_service_postgres-cli.yaml)
//   4. Default values
//
// Usage examples:
...
//   export NODE_SERVICE_POSTGRES_SERVER=https://node_service_postgres.example.com
//   export NODE_SERVICE_POSTGRES_VERSION=v2beta1
//   client node list
//
...
import (
	...
	"github.com/openchami/node-service-postgres/pkg/client"
...
var rootCmd = &cobra.Command{
	...
	Short: "node_service_postgres CLI",
	Long:  `A command-line interface for managing node_service_postgres resources.`,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.node_service_postgres-cli.yaml)")
	rootCmd.PersistentFlags().StringVar(&serverURL, "server", "http://localhost:8080", "node_service_postgres server URL")
	...
	viper.SetEnvPrefix("NODE_SERVICE_POSTGRES")
	viper.AutomaticEnv()
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".node_service_postgres-cli")
	}
