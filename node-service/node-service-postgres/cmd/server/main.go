...
import (
	...
	_ "github.com/openchami/node-service-postgres/pkg/apiversion"
...
func DefaultConfig() *Config {
	return &Config{
		...
		DatabaseURL:  "postgres://localhost/node-service-postgres?sslmode=disable",
...
var rootCmd = &cobra.Command{
	Use:   "node-service-postgres",
	Short: "",
	Long:  `node-service-postgres - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the node-service-postgres server",
	Long:  `Start the node-service-postgres HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.node-service-postgres.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".node-service-postgres")
	}
...
func runServer(cmd *cobra.Command, args []string) error {
	log.Printf("Starting node-service-postgres server...")
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"node-service-postgres"}`))
}
