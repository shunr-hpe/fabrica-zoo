...
// CreateNamedRequest represents a request to create a Named (Advanced API)
// Use this when you need full control over metadata fields (labels, annotations).
// For simpler usage, see CreateNamedSimple in the client.
type CreateNamedRequest struct {
	Metadata    fabrica.Metadata  `json:"metadata" yaml:"metadata" validate:"required"`
	Spec        v1.NamedSpec      `json:"spec" yaml:"spec" validate:"required"`
	Labels      map[string]string `json:"labels,omitempty" yaml:"labels,omitempty"`
	Annotations map[string]string `json:"annotations,omitempty" yaml:"annotations,omitempty"`
}

// UpdateNamedRequest represents a request to update a Named (Advanced API)
// Use this when you need to update metadata fields along with the spec.
// For simpler usage, see UpdateNamedSimple in the client.
type UpdateNamedRequest struct {
	Metadata    fabrica.Metadata  `json:"metadata,omitempty" yaml:"metadata,omitempty"`
	Spec        v1.NamedSpec      `json:"spec,omitempty" yaml:"spec,omitempty" validate:"omitempty"`
	Labels      map[string]string `json:"labels,omitempty" yaml:"labels,omitempty"`
	Annotations map[string]string `json:"annotations,omitempty" yaml:"annotations,omitempty"`
}
