...
// NamedMutation represents an operation that mutates the Named nodes in the graph.
type NamedMutation struct {
	...
	spec_data                 *json.RawMessage
	appendspec_data           json.RawMessage
	spec_name                 *string
	spec_alt_name             *string
	spec_number               *int
	addspec_number            *int
	spec_something_or_nothing *string
	clearedFields             map[string]struct{}
	done                      bool
	oldValue                  func(context.Context) (*Named, error)
	predicates                []predicate.Named
}

var _ ent.Mutation = (*NamedMutation)(nil)

// namedOption allows management of the mutation configuration using functional options.
type namedOption func(*NamedMutation)

// newNamedMutation creates new mutation for the Named entity.
func newNamedMutation(c config, op Op, opts ...namedOption) *NamedMutation {
	m := &NamedMutation{
		config:        c,
		op:            op,
		typ:           TypeNamed,
...
// withNamedID sets the ID field of the mutation.
func withNamedID(id int) namedOption {
	return func(m *NamedMutation) {
		var (
			err   error
			once  sync.Once
			value *Named
		)
		m.oldValue = func(ctx context.Context) (*Named, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().Named.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withNamed sets the old Named of the mutation.
func withNamed(node *Named) namedOption {
	return func(m *NamedMutation) {
		m.oldValue = func(context.Context) (*Named, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m NamedMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m NamedMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *NamedMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *NamedMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().Named.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *NamedMutation) SetUID(s string) {
	m.uid = &s
}

// UID returns the value of the "uid" field in the mutation.
func (m *NamedMutation) UID() (r string, exists bool) {
	v := m.uid
	if v == nil {
		return
	}
...
// OldUID returns the old "uid" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldUID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NamedMutation) ResetUID() {
	m.uid = nil
}

// SetName sets the "name" field.
func (m *NamedMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *NamedMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NamedMutation) ResetName() {
	m.name = nil
}

// SetNamespace sets the "namespace" field.
func (m *NamedMutation) SetNamespace(s string) {
	m.namespace = &s
}

// Namespace returns the value of the "namespace" field in the mutation.
func (m *NamedMutation) Namespace() (r string, exists bool) {
	v := m.namespace
	if v == nil {
		return
	}
...
// OldNamespace returns the old "namespace" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldNamespace(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NamedMutation) ClearNamespace() {
	m.namespace = nil
	m.clearedFields[named.FieldNamespace] = struct{}{}
}

// NamespaceCleared returns if the "namespace" field was cleared in this mutation.
func (m *NamedMutation) NamespaceCleared() bool {
	_, ok := m.clearedFields[named.FieldNamespace]
	return ok
}

// ResetNamespace resets all changes to the "namespace" field.
func (m *NamedMutation) ResetNamespace() {
	m.namespace = nil
	delete(m.clearedFields, named.FieldNamespace)
}

// SetAPIVersion sets the "api_version" field.
func (m *NamedMutation) SetAPIVersion(s string) {
	m.api_version = &s
}

// APIVersion returns the value of the "api_version" field in the mutation.
func (m *NamedMutation) APIVersion() (r string, exists bool) {
	v := m.api_version
	if v == nil {
		return
	}
...
// OldAPIVersion returns the old "api_version" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldAPIVersion(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NamedMutation) ResetAPIVersion() {
	m.api_version = nil
}

// SetKind sets the "kind" field.
func (m *NamedMutation) SetKind(s string) {
	m.kind = &s
}

// Kind returns the value of the "kind" field in the mutation.
func (m *NamedMutation) Kind() (r string, exists bool) {
	v := m.kind
	if v == nil {
		return
	}
...
// OldKind returns the old "kind" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldKind(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NamedMutation) ResetKind() {
	m.kind = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *NamedMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *NamedMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NamedMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *NamedMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *NamedMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// OldResourceVersion returns the old "resource_version" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldResourceVersion(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NamedMutation) ResetResourceVersion() {
	m.resource_version = nil
}

// SetSpecData sets the "spec_data" field.
func (m *NamedMutation) SetSpecData(jm json.RawMessage) {
	m.spec_data = &jm
	m.appendspec_data = nil
}

// SpecData returns the value of the "spec_data" field in the mutation.
func (m *NamedMutation) SpecData() (r json.RawMessage, exists bool) {
	v := m.spec_data
	if v == nil {
		return
	}
...
// OldSpecData returns the old "spec_data" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldSpecData(ctx context.Context) (v json.RawMessage, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecData is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecData requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecData: %w", err)
	}
	return oldValue.SpecData, nil
}

// AppendSpecData adds jm to the "spec_data" field.
func (m *NamedMutation) AppendSpecData(jm json.RawMessage) {
	m.appendspec_data = append(m.appendspec_data, jm...)
}

// AppendedSpecData returns the list of values that were appended to the "spec_data" field in this mutation.
func (m *NamedMutation) AppendedSpecData() (json.RawMessage, bool) {
	if len(m.appendspec_data) == 0 {
		return nil, false
	}
	return m.appendspec_data, true
}

// ClearSpecData clears the value of the "spec_data" field.
func (m *NamedMutation) ClearSpecData() {
	m.spec_data = nil
	m.appendspec_data = nil
	m.clearedFields[named.FieldSpecData] = struct{}{}
}

// SpecDataCleared returns if the "spec_data" field was cleared in this mutation.
func (m *NamedMutation) SpecDataCleared() bool {
	_, ok := m.clearedFields[named.FieldSpecData]
	return ok
}

// ResetSpecData resets all changes to the "spec_data" field.
func (m *NamedMutation) ResetSpecData() {
	m.spec_data = nil
	m.appendspec_data = nil
	delete(m.clearedFields, named.FieldSpecData)
}

// SetSpecName sets the "spec_name" field.
func (m *NamedMutation) SetSpecName(s string) {
	m.spec_name = &s
}

// SpecName returns the value of the "spec_name" field in the mutation.
func (m *NamedMutation) SpecName() (r string, exists bool) {
	v := m.spec_name
	if v == nil {
		return
	}
...
// OldSpecName returns the old "spec_name" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldSpecName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecName requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecName: %w", err)
	}
	return oldValue.SpecName, nil
}

// ClearSpecName clears the value of the "spec_name" field.
func (m *NamedMutation) ClearSpecName() {
	m.spec_name = nil
	m.clearedFields[named.FieldSpecName] = struct{}{}
}

// SpecNameCleared returns if the "spec_name" field was cleared in this mutation.
func (m *NamedMutation) SpecNameCleared() bool {
	_, ok := m.clearedFields[named.FieldSpecName]
	return ok
}

// ResetSpecName resets all changes to the "spec_name" field.
func (m *NamedMutation) ResetSpecName() {
	m.spec_name = nil
	delete(m.clearedFields, named.FieldSpecName)
}

// SetSpecAltName sets the "spec_alt_name" field.
func (m *NamedMutation) SetSpecAltName(s string) {
	m.spec_alt_name = &s
}

// SpecAltName returns the value of the "spec_alt_name" field in the mutation.
func (m *NamedMutation) SpecAltName() (r string, exists bool) {
	v := m.spec_alt_name
	if v == nil {
		return
	}
...
// OldSpecAltName returns the old "spec_alt_name" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldSpecAltName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecAltName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecAltName requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecAltName: %w", err)
	}
	return oldValue.SpecAltName, nil
}

// ResetSpecAltName resets all changes to the "spec_alt_name" field.
func (m *NamedMutation) ResetSpecAltName() {
	m.spec_alt_name = nil
}

// SetSpecNumber sets the "spec_number" field.
func (m *NamedMutation) SetSpecNumber(i int) {
	m.spec_number = &i
	m.addspec_number = nil
}

// SpecNumber returns the value of the "spec_number" field in the mutation.
func (m *NamedMutation) SpecNumber() (r int, exists bool) {
	v := m.spec_number
	if v == nil {
		return
	}
...
// OldSpecNumber returns the old "spec_number" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldSpecNumber(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecNumber is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecNumber requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecNumber: %w", err)
	}
	return oldValue.SpecNumber, nil
}

// AddSpecNumber adds i to the "spec_number" field.
func (m *NamedMutation) AddSpecNumber(i int) {
	if m.addspec_number != nil {
		*m.addspec_number += i
	} else {
		m.addspec_number = &i
	}
...
// AddedSpecNumber returns the value that was added to the "spec_number" field in this mutation.
func (m *NamedMutation) AddedSpecNumber() (r int, exists bool) {
	v := m.addspec_number
	if v == nil {
		return
	}
...
func (m *NamedMutation) ClearSpecNumber() {
	m.spec_number = nil
	m.addspec_number = nil
	m.clearedFields[named.FieldSpecNumber] = struct{}{}
}

// SpecNumberCleared returns if the "spec_number" field was cleared in this mutation.
func (m *NamedMutation) SpecNumberCleared() bool {
	_, ok := m.clearedFields[named.FieldSpecNumber]
	return ok
}

// ResetSpecNumber resets all changes to the "spec_number" field.
func (m *NamedMutation) ResetSpecNumber() {
	m.spec_number = nil
	m.addspec_number = nil
	delete(m.clearedFields, named.FieldSpecNumber)
}

// SetSpecSomethingOrNothing sets the "spec_something_or_nothing" field.
func (m *NamedMutation) SetSpecSomethingOrNothing(s string) {
	m.spec_something_or_nothing = &s
}

// SpecSomethingOrNothing returns the value of the "spec_something_or_nothing" field in the mutation.
func (m *NamedMutation) SpecSomethingOrNothing() (r string, exists bool) {
	v := m.spec_something_or_nothing
	if v == nil {
		return
	}
	return *v, true
...
// OldSpecSomethingOrNothing returns the old "spec_something_or_nothing" field's value of the Named entity.
// If the Named object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NamedMutation) OldSpecSomethingOrNothing(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSpecSomethingOrNothing is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSpecSomethingOrNothing requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSpecSomethingOrNothing: %w", err)
	}
	return oldValue.SpecSomethingOrNothing, nil
}

// ClearSpecSomethingOrNothing clears the value of the "spec_something_or_nothing" field.
func (m *NamedMutation) ClearSpecSomethingOrNothing() {
	m.spec_something_or_nothing = nil
	m.clearedFields[named.FieldSpecSomethingOrNothing] = struct{}{}
}

// SpecSomethingOrNothingCleared returns if the "spec_something_or_nothing" field was cleared in this mutation.
func (m *NamedMutation) SpecSomethingOrNothingCleared() bool {
	_, ok := m.clearedFields[named.FieldSpecSomethingOrNothing]
	return ok
}

// ResetSpecSomethingOrNothing resets all changes to the "spec_something_or_nothing" field.
func (m *NamedMutation) ResetSpecSomethingOrNothing() {
	m.spec_something_or_nothing = nil
	delete(m.clearedFields, named.FieldSpecSomethingOrNothing)
}

// Where appends a list predicates to the NamedMutation builder.
func (m *NamedMutation) Where(ps ...predicate.Named) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the NamedMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *NamedMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Named, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *NamedMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *NamedMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (Named).
func (m *NamedMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *NamedMutation) Fields() []string {
	fields := make([]string, 0, 13)
	if m.uid != nil {
		fields = append(fields, named.FieldUID)
	}
	if m.name != nil {
		fields = append(fields, named.FieldName)
	}
	if m.namespace != nil {
		fields = append(fields, named.FieldNamespace)
	}
	if m.api_version != nil {
		fields = append(fields, named.FieldAPIVersion)
	}
	if m.kind != nil {
		fields = append(fields, named.FieldKind)
	}
	if m.created_at != nil {
		fields = append(fields, named.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, named.FieldUpdatedAt)
	}
	if m.resource_version != nil {
		fields = append(fields, named.FieldResourceVersion)
	}
	if m.spec_data != nil {
		fields = append(fields, named.FieldSpecData)
	}
	if m.spec_name != nil {
		fields = append(fields, named.FieldSpecName)
	}
	if m.spec_alt_name != nil {
		fields = append(fields, named.FieldSpecAltName)
	}
	if m.spec_number != nil {
		fields = append(fields, named.FieldSpecNumber)
	}
	if m.spec_something_or_nothing != nil {
		fields = append(fields, named.FieldSpecSomethingOrNothing)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *NamedMutation) Field(name string) (ent.Value, bool) {
	switch name {
	case named.FieldUID:
		return m.UID()
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *NamedMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case named.FieldUID:
		return m.OldUID(ctx)
	case named.FieldName:
	...
	case named.FieldSpecData:
		return m.OldSpecData(ctx)
	case named.FieldSpecName:
		return m.OldSpecName(ctx)
	case named.FieldSpecAltName:
		return m.OldSpecAltName(ctx)
	case named.FieldSpecNumber:
		return m.OldSpecNumber(ctx)
	case named.FieldSpecSomethingOrNothing:
		return m.OldSpecSomethingOrNothing(ctx)
	}
	return nil, fmt.Errorf("unknown Named field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *NamedMutation) SetField(name string, value ent.Value) error {
	switch name {
	case named.FieldUID:
		v, ok := value.(string)
		if !ok {
	...
	case named.FieldSpecSomethingOrNothing:
		...
		m.SetSpecSomethingOrNothing(v)
		return nil
	}
	return fmt.Errorf("unknown Named field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *NamedMutation) AddedFields() []string {
	var fields []string
	if m.addspec_number != nil {
		fields = append(fields, named.FieldSpecNumber)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *NamedMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case named.FieldSpecNumber:
		return m.AddedSpecNumber()
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *NamedMutation) AddField(name string, value ent.Value) error {
	switch name {
	case named.FieldSpecNumber:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown Named numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *NamedMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(named.FieldNamespace) {
		fields = append(fields, named.FieldNamespace)
	}
	if m.FieldCleared(named.FieldSpecData) {
		fields = append(fields, named.FieldSpecData)
	}
	if m.FieldCleared(named.FieldSpecName) {
		fields = append(fields, named.FieldSpecName)
	}
	if m.FieldCleared(named.FieldSpecNumber) {
		fields = append(fields, named.FieldSpecNumber)
	}
	if m.FieldCleared(named.FieldSpecSomethingOrNothing) {
		fields = append(fields, named.FieldSpecSomethingOrNothing)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *NamedMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *NamedMutation) ClearField(name string) error {
	switch name {
	case named.FieldNamespace:
		m.ClearNamespace()
		return nil
	...
	case named.FieldSpecNumber:
		...
		return nil
	case named.FieldSpecSomethingOrNothing:
		m.ClearSpecSomethingOrNothing()
		return nil
	}
	return fmt.Errorf("unknown Named nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *NamedMutation) ResetField(name string) error {
	switch name {
	case named.FieldUID:
		m.ResetUID()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *NamedMutation) AddedEdges() []string {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *NamedMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *NamedMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *NamedMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *NamedMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *NamedMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *NamedMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown Named unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *NamedMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown Named edge %s", name)
}
