...
var (
	...
	// NamedsColumns holds the columns for the "nameds" table.
	NamedsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		...
		{Name: "kind", Type: field.TypeString, Default: "Named"},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "resource_version", Type: field.TypeString, Default: "1"},
		{Name: "spec_data", Type: field.TypeJSON, Nullable: true},
		{Name: "spec_name", Type: field.TypeString, Unique: true, Nullable: true},
		{Name: "spec_alt_name", Type: field.TypeString, Size: 64},
		{Name: "spec_number", Type: field.TypeInt, Nullable: true, Default: 0},
		{Name: "spec_something_or_nothing", Type: field.TypeString, Nullable: true},
	}
	// NamedsTable holds the schema information for the "nameds" table.
	NamedsTable = &schema.Table{
		Name:       "nameds",
		Columns:    NamedsColumns,
		PrimaryKey: []*schema.Column{NamedsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "named_uid",
				Unique:  true,
				Columns: []*schema.Column{NamedsColumns[1]},
			},
			{
				Name:    "named_name_namespace",
				Unique:  false,
				Columns: []*schema.Column{NamedsColumns[2], NamedsColumns[3]},
			},
			{
				Name:    "idx_named_name",
				Unique:  false,
				Columns: []*schema.Column{NamedsColumns[10]},
			},
			{
				Name:    "idx_named_altname_name",
				Unique:  true,
				Columns: []*schema.Column{NamedsColumns[11], NamedsColumns[10]},
			},
		},
	}
