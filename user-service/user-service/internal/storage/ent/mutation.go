...
type ResourceMutation struct {
	...
	spec               *jsontext.Value
	appendspec         jsontext.Value
	status             *jsontext.Value
	appendstatus       jsontext.Value
...
func (m *ResourceMutation) SetSpec(j jsontext.Value) {
	m.spec = &j
	m.appendspec = nil
}

// Spec returns the value of the "spec" field in the mutation.
func (m *ResourceMutation) Spec() (r jsontext.Value, exists bool) {
	v := m.spec
	if v == nil {
		return
	}
...
// If the Resource object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResourceMutation) OldSpec(ctx context.Context) (v jsontext.Value, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// AppendSpec adds j to the "spec" field.
func (m *ResourceMutation) AppendSpec(j jsontext.Value) {
	m.appendspec = append(m.appendspec, j...)
}

// AppendedSpec returns the list of values that were appended to the "spec" field in this mutation.
func (m *ResourceMutation) AppendedSpec() (jsontext.Value, bool) {
...
func (m *ResourceMutation) SetStatus(j jsontext.Value) {
	m.status = &j
	m.appendstatus = nil
}

// Status returns the value of the "status" field in the mutation.
func (m *ResourceMutation) Status() (r jsontext.Value, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// If the Resource object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResourceMutation) OldStatus(ctx context.Context) (v jsontext.Value, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// AppendStatus adds j to the "status" field.
func (m *ResourceMutation) AppendStatus(j jsontext.Value) {
	m.appendstatus = append(m.appendstatus, j...)
}

// AppendedStatus returns the list of values that were appended to the "status" field in this mutation.
func (m *ResourceMutation) AppendedStatus() (jsontext.Value, bool) {
