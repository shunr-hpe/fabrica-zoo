...
import (
	...
	_ "github.com/openchami/user-service-pr-sqlite/pkg/apiversion"
...
var rootCmd = &cobra.Command{
	Use:   "user-service-pr-sqlite",
	Short: "",
	Long:  `user-service-pr-sqlite - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the user-service-pr-sqlite server",
	Long:  `Start the user-service-pr-sqlite HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.user-service-pr-sqlite.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".user-service-pr-sqlite")
	}
...
func runServer(cmd *cobra.Command, args []string) error {
	log.Printf("Starting user-service-pr-sqlite server...")
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"user-service-pr-sqlite"}`))
}
